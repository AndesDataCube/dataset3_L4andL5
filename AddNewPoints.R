...
wrs_tiles <- read_sf("data/TilesWorld.gpkg", layer = "L8L9")
...
points <- st_read("data/cloudsen12_metadata.geojson")
...
# Convert the combined dataframe to a spatial points data frame.
sf_points <- st_as_sf(sf_points_df, coords = c("X", "Y"))
